...
import 'package:catalansalmon_flutter/widgets/loader_widget.dart';
        ...
        body: SafeArea(
          ...
          if (state is LoginSuccessIntroState) {
            Navigator.of(context).pushReplacement(MaterialPageRoute(
                builder: (context) =>
                    CommunityPage.fromDetails(state.details)));
          }
        }, builder: (context, state) {
          if (state is ResponseIntroState) {
            return CommunitySelectionWidget(
                communities: state.nearbyCommunities);
          }
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('Uneix-te a una de les comunitats a prop teu!',
            ...
            return CommunityButton(
              ...
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => CommunityPage(community: com)));
              },
            );
          }),
